...
* Runs on Ubuntu (Precise 14.04 64 Bit) \w PHP 5.5, MySQL 5.5, Apache 2.2
...
* Clone or [download](https://github.com/cookieflow/simple-magento-vagrant/archive/master.zip) this repository to the root of your project directory `git clone https://github.com/raybogman/magento-vagrant-sd.git`
